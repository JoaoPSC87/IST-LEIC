...
public class VeretinarianSatisfactionCalculator implements EmployeeSatisfactionCalculator, Serializable {
    ...
    private double workload(Employee e) {
        ...
        for(Species species : vet.getAssignedSpecies()) {
            workload += species.getPopulation() / (species.getAvailableVets()):
        }
        return workload;
    }
