    ...
    <v-card>
      ...
      <v-card-text>
        <v-form ref="form" lazy-validation>
          <v-row>
            <v-col cols="12" v-if="editParticipation.id === null">
              <v-select
                label="Shift"
                ...
                data-cy="participantShiftSelect"
              ></v-select>
            </v-col>
      ...
      <v-card-actions>
        ...
        <v-btn
          v-if="isReviewValid && isRatingValid && isShiftValid"
          color="primary"
          dark
          variant="text"
...
export default class ParticipationSelectionDialog extends Vue {
  ...
  readonly availableShifts!: Shift[];
  ...
  async created() {
    ...
    if (this.editParticipation.id === null && this.availableShifts.length > 0) {
      this.editParticipation.shiftId = this.availableShifts[0].id;
    }
  ...
  get isShiftValid(): boolean {
    return this.editParticipation.id !== null || this.editParticipation.shiftId !== null;
  }
